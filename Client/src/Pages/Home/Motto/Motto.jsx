...
const Motto = () => {
  return (
    <section className="px-4 sm:px-6 lg:px-12 py-12">
      <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden transition duration-300 ease-in-out hover:scale-105 hover:shadow-red-700  shadow-2xl">
        <div className="relative p-10 sm:p-12">
          ...
          <div className="relative space-y-4 text-center">
            <p className="text-sm uppercase tracking-[0.35em] ">Our Vision</p>
            <h1 className="text-2xl sm:text-3xl font-semibold font-secondary">
              No one should wait for hope to arrive
            </h1>
            <p className="font-secondary text-sm sm:text-base max-w-3xl mx-auto">
